Shader "Universal Render Pipeline/Baked Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.triband.render-pipelines.universal/Shaders/BakedLitInput.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.triband.render-pipelines.universal/Shaders/BakedLitInput.hlsl"
            #include "Packages/com.triband.render-pipelines.universal/Shaders/BakedLitMetaPass.hlsl"
