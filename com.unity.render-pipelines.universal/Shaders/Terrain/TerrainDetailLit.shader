Shader "Hidden/TerrainEngine/Details/UniversalPipeline/Vertexlit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.triband.render-pipelines.universal/ShaderLibrary/Core.hlsl"
            #include "Packages/com.triband.render-pipelines.universal/ShaderLibrary/Lighting.hlsl"
            #include "Packages/com.triband.render-pipelines.universal/ShaderLibrary/UnityGBuffer.hlsl"
        ...
        Pass
        {
            ...
            #include "Packages/com.triband.render-pipelines.universal/Shaders/Terrain/TerrainLitInput.hlsl"
            #include "Packages/com.triband.render-pipelines.universal/Shaders/Terrain/TerrainLitPasses.hlsl"
            ENDHLSL
        }
        ...
        Pass
        {
            ...
            #include "Packages/com.triband.render-pipelines.universal/Shaders/SimpleLitInput.hlsl"
            #include "Packages/com.triband.render-pipelines.universal/Shaders/SimpleLitMetaPass.hlsl"
