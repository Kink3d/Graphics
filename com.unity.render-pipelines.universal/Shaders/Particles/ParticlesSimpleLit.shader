...
Shader "Universal Render Pipeline/Particles/Simple Lit"
{
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            #include "Packages/com.triband.render-pipelines.universal/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Packages/com.triband.render-pipelines.universal/Shaders/Particles/ParticlesSimpleLitForwardPass.hlsl"
            ENDHLSL
        }
        // ------------------------------------------------------------------
        //  GBuffer pass.
        Pass
        {
            ...
            #include "Packages/com.triband.render-pipelines.universal/Shaders/Particles/ParticlesSimpleLitInput.hlsl"
            #include "Packages/com.triband.render-pipelines.universal/Shaders/Particles/ParticlesSimpleLitGBufferPass.hlsl"
            ENDHLSL
        }
        // ------------------------------------------------------------------
