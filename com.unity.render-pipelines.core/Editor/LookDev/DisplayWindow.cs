...
namespace UnityEditor.Rendering.LookDev
{
    ...
    partial class DisplayWindow : EditorWindow, IViewDisplayer
    {
        ...
        {
            internal const string k_IconFolder = @"Packages/com.triband.render-pipelines.core/Editor/LookDev/Icons/";
            internal const string k_uss = @"Packages/com.triband.render-pipelines.core/Editor/LookDev/DisplayWindow.uss";
            internal const string k_uss_personal_overload = @"Packages/com.triband.render-pipelines.core/Editor/LookDev/DisplayWindow-PersonalSkin.uss";
