...
namespace UnityEditor.Rendering.LookDev
{
    ...
    class EnvironmentElement : VisualElement, IBendable<Environment>
    {
        ...
        public VisualElement GetDefaultInspector()
        {
            ...
            {
                image = CoreEditorUtils.LoadIcon(@"Packages/com.triband.render-pipelines.core/Editor/LookDev/Icons/", "Environment", forceLowRes: true)
            });
            ...
            {
                image = CoreEditorUtils.LoadIcon(@"Packages/com.triband.render-pipelines.core/Editor/LookDev/Icons/", "SunPosition", forceLowRes: true)
            });
