...
class VFXManagerEditor : Editor
{
    ...
    public static void CheckVFXManager()
    {
        ...
        shaderModified |= SetBuiltInShaderIfNeeded(obj, "m_IndirectShader",     "Packages/com.triband.visualeffectgraph/Shaders/VFXFillIndirectArgs.compute");
        shaderModified |= SetBuiltInShaderIfNeeded(obj, "m_CopyBufferShader",   "Packages/com.triband.visualeffectgraph/Shaders/VFXCopyBuffer.compute");
        shaderModified |= SetBuiltInShaderIfNeeded(obj, "m_SortShader",         "Packages/com.triband.visualeffectgraph/Shaders/Sort.compute");
        shaderModified |= SetBuiltInShaderIfNeeded(obj, "m_StripUpdateShader",  "Packages/com.triband.visualeffectgraph/Shaders/UpdateStrips.compute");
